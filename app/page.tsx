    ...
    <main style={{ background: "#FBF4E4", color: "#242424", overflowX: "hidden" }}>
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-20 text-center">
        ...
        <div className="animate-float mb-6">
          <div
            className="rounded-full p-6 shadow-2xl inline-block"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: "📅", title: "Wann?",
                lines: ["Sonntag", "7. Juni", "2026"],
                border: "#E75C7D", iconBg: "#E75C7D",
              },
              {
                icon: "🕒", title: "Uhrzeit?",
                lines: ["Beginn um", "15:00 Uhr", "bis ca. 18:00"],
                border: "#C8C72A", iconBg: "#C8C72A",
              },
              {
                icon: "🏠", title: "Wo?",
                lines: ["Bei uns", "Zuhause", "Adresse folgt"],
                border: "#E75C7D", iconBg: "#E75C7D",
              },
            ].map(card => (
              <div
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-3" style={{ color: "#242424" }}>
                  {card.title}
                </h3>
                {card.lines.map((line, i) => (
                  <p
                    key={i}
                    className={i === 1 ? "text-3xl font-bold" : "text-lg"}
                    style={{ color: i === 1 ? card.border : "#242424" }}
                  >
                    {line}
                  </p>
                ))}
      ...
      <section className="relative z-10 py-20 px-4" style={{ background: "#fff" }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-4 md:grid-cols-6 gap-4">
            {GALLERY.map((emoji, i) => {
              const bg = i % 2 === 0 ? "#E75C7D" : (i % 3 === 0 ? "#242424" : "#C8C72A");
              return (
                <div
                  key={emoji}
        ...
        <div className="max-w-xl mx-auto">
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-lg font-medium" style={{ color: "#555" }}>
                Bitte bis zum{" "}
      ...
      <section className="relative z-10 py-20 px-4" style={{ background: "#FBF4E4" }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg font-medium mb-8" style={{ color: "#555" }}>
            ...
            Aber das Wichtigste ist: <strong style={{ color: "#E75C7D" }}>DASS IHR DA SEID!</strong> 🎈
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            {["📚 Bücher", "🧸 Kuscheltiere", "🎨 Mal-Sachen", "🧩 Puzzle & Spiele", "🪀 Spielzeug"].map(item => (
              <span
                ...
                style={{ background: "#fff", color: "#242424" }}
              >
                {item}
              </span>
            ))}
      ...
      <footer className="relative z-10 py-12 px-4 text-center" style={{ background: "#242424", color: "#fff" }}>
        ...
        <p className="mb-6" style={{ color: "#aaa" }}>
          Bei Fragen:{" "}
          <a href="mailto:ismailkilicaslan61@gmail.com" className="transition-colors hover:text-[#C8C72A]" style={{ color: "#E75C7D" }}>
            ismailkilicaslan61@gmail.com
          </a>
        </p>
